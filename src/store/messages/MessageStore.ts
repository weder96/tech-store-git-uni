...
class MessageStore {
   ...
   /**
     ...
     * @param {Array} erros
     */
    exibirMensagensErro(erros: (string | number)[]) {
        this.message.show(
            erros.map((msg: any) => {
     ...
     * @param {Array} sucess
     */
    exibirMensagensSucesso(sucess: (string | number)[]) {
        this.message.show(
            sucess.map((msg: any) => {
     ...
     * @param {Array} info
     */
      exibirMensagensInfo(info: (string | number)[]) {
        this.message.show(
            info.map((msg: any) => {
     ...
     * @param {Array} warn
     */
       exibirMensagensWarn(warn: (string | number)[]) {
        this.message.show(
            warn.map((msg: any) => {
